...
from config import (AddConfig, AppConfig, BaseEmbedderConfig,
                               BaseLlmConfig, ChromaDbConfig)
from embedder.base import BaseEmbedder
from llm.base import BaseLlm
from vectordb.base import BaseVectorDB, BaseVectorDbConfig
...
class TestAppFromConfig:
    ...
    def test_from_chroma_config(self, mocker):
        mocker.patch("vectordb.chroma.chromadb.Client")

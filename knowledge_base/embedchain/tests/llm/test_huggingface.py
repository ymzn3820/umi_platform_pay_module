...
def test_get_llm_model_answer(huggingface_llm_config, mocker):
    mocker.patch("llm.huggingface.HuggingFaceLlm._get_answer", return_value="Test answer")
...
def test_hugging_face_mock(huggingface_llm_config, mocker):
    ...
    mocker.patch("llm.huggingface.HuggingFaceHub", return_value=mock_llm_instance)

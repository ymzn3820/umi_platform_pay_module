...
from config import ZillizDBConfig
from vectordb.zilliz import ZillizVectorDB
...
class TestZillizVectorDB:
    ...
    @patch("vectordb.zilliz.MilvusClient", autospec=True)
    @patch("vectordb.zilliz.connections.connect", autospec=True)
...
class TestZillizDBCollection:
    ...
    @patch("vectordb.zilliz.MilvusClient", autospec=True)
    @patch("vectordb.zilliz.connections", autospec=True)

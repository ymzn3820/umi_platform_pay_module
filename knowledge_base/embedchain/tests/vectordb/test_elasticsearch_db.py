...
from config import AppConfig, ElasticsearchDBConfig
from embedder.gpt4all import GPT4AllEmbedder
from vectordb.elasticsearch import ElasticsearchDB


class TestEsDB(unittest.TestCase):
    @patch("vectordb.elasticsearch.Elasticsearch")

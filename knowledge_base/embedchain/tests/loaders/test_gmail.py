...
def mock_quopri(mocker):
    return mocker.patch("loaders.gmail.quopri.decodestring", return_value=b"your_test_decoded_string")


@pytest.fixture
def mock_beautifulsoup(mocker):
    return mocker.patch("loaders.gmail.BeautifulSoup", return_value=mocker.MagicMock())

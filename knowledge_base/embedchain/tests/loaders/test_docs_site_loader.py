...
def test_load_data_gets_by_selectors_and_ignored_tags(selectee, ignored_tag, loader, mocked_responses, mocker):
    child_url = "https://docs.ai/quickstart"
...
"""
    ...
    mock_sha256 = mocker.patch("loaders.docs_site_loader.hashlib.sha256")
    doc_id = "mocked_hash"
    ...
    assert result["data"] == [
        {
            ...
            "meta_data": {"url": "https://docs.ai/quickstart"},
        }
    ]
...
"""
    ...
    child_url = "https://docs.ai/introduction"
    html_body = """
<!DOCTYPE html>
<html lang="en">
<body>
...
"""
    ...
    expected_data = [
        {"content": "..\n.", "meta_data": {"url": "https://docs.ai/quickstart"}},
        {"content": "..\n.", "meta_data": {"url": "https://docs.ai/introduction"}},
    ]
...
@pytest.fixture
def loader():
    from loaders.docs_site_loader import DocsSiteLoader

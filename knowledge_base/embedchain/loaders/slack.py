...
class SlackLoader(BaseLoader):
    ...
    def _setup_loader(self, config: Dict[str, Any]):
        ...
        if os.getenv("SLACK_USER_TOKEN") is None:
            raise ValueError(
                "SLACK_USER_TOKEN environment variables not provided. Check `https://docs.ai/data-sources/slack` to learn more."  # noqa:E501
            )
    ...
    def _check_query(self, query):
        if not isinstance(query, str):
            raise ValueError(
                f"Invalid query passed to Slack loader, found: {query}. Check `https://docs.ai/data-sources/slack` to learn more."  # noqa:E501
            )
    ...
    def load_data(self, query):
        ...
        try:
            ...
            raise ValueError(
                f"Error in loading slack data: {e}. Check `https://docs.ai/data-sources/slack` to learn more."  # noqa:E501
            ) from e

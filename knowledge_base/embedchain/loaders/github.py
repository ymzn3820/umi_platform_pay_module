...
class GithubLoader(BaseLoader):
    ...
    def _get_valid_github_query(self, query: str):
        ...
        if len(query_terms) < 1 or "repo:" not in query:
            raise ValueError(
                "GithubLoader requires a search query with `repo:` term. Refer docs - `https://docs.ai/data-sources/github`"  # noqa: E501
            )
        ...
        if len(types) == 0:
            raise ValueError(
                "GithubLoader requires a search query with `type:` term. Refer docs - `https://docs.ai/data-sources/github`"  # noqa: E501
            )
    ...
    def load_data(self, search_query: str, max_results: int = 1000):
        ...
        if not self.client:
            raise ValueError(
                "GithubLoader client is not initialized, data will not be loaded. Refer docs - `https://docs.ai/data-sources/github`"  # noqa: E501
            )

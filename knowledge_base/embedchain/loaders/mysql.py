    ...
    def __init__(self, config: Optional[Dict[str, Any]]):
        ...
        if not config:
            raise ValueError(
                ...
                "Provide the correct config, refer `https://docs.ai/data-sources/mysql`.",
            )
        ...
        try:
            ...
            raise ValueError(
                ...
                "Please provide the correct configuration to load data from you MySQL DB. \
                    Refer `https://docs.ai/data-sources/mysql`.",
            )
        ...
        if not isinstance(query, str):
            raise ValueError(
                ...
                "Provide the valid query to add from mysql, \
                    make sure you are following `https://docs.ai/data-sources/mysql`",
            )
